            ...
            {temples.map((temple) => {
              ...
              <li key={temple.id}>
                <button
                  ...
                  className={`w-full rounded-sm px-3 py-3 text-left transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-cinnabar ${
                    hasMurals
                      ? "hover:bg-parchment/80"
                ...
                >
                  ...
                  {!hasMurals && (
                    <span className="mt-1.5 block font-sans text-[10px] tracking-wider text-stone/45">
                      {t("nav.muralsClosed")}
                    </span>
                  )}
                </button>
