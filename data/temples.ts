...
export const temples: Temple[] = [
  ...
  },
  {
    ...
    region: "山西·阳曲",
    era: "金代",
    tagline: "山间古刹里的早期佛教遗存",
    description:
      "不二寺地处太原近郊，殿内壁画与塑像共同构成完整的宗教空间，是研究晋中地区金代佛教艺术的重要实例。",
    keywords: ["金代壁画", "阳曲", "佛教遗存"],
    image: "/images/temples/buer.svg",
    imageAlt: "不二寺壁画局部",
    detailImage: "/images/temples/buer-detail.svg",
    detailImageAlt: "不二寺壁画全景",
    coordinates: [112.66, 38.052],
  },
  {
    id: "longquan",
    name: "龙泉寺",
  ...
  },
  {
    id: "shuishen",
    name: "水神堂",
    nameEn: "Shuishen Hall",
    region: "山西·洪洞",
    era: "元代",
    tagline: "祈雨仪式与戏剧舞台的交汇",
    description:
      "水神堂即广胜寺下院水神庙，壁画以元杂剧题材闻名，将戏曲表演、祭祀仪式与神话叙事绘制于同一空间。",
    keywords: ["元杂剧", "祈雨信仰", "戏剧壁画"],
    image: "/images/temples/shuishen.svg",
    imageAlt: "水神堂壁画中的戏剧表演场景",
    detailImage: "/images/temples/shuishen-detail.svg",
    detailImageAlt: "水神堂壁画全景",
    coordinates: [111.806, 36.302],
  },
];
