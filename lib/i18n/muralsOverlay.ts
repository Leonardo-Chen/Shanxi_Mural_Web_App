...
export const muralOverlays: Record<string, MuralOverlay> = {
  "lm-m01": {
    title: {
      en: "The Dragon Mother Departs to Bring Rain",
      it: "La Madre Drago esce a portare la pioggia",
    },
    displayTitle: {
      en: "The Dragon Mother Departs to Bring Rain",
      it: "La Madre Drago esce a portare la pioggia",
    ...
    summary: {
      en: "After the people pray for rain, the Jiujiang Holy Mother leads Thunder Lord, Lightning Mother, Wind Earl, Rain Master, cloud generals, officials, water spirits and a retinue out of the palace to bring rain from the divine realm into the human world.",
      it: "Dopo la preghiera per la pioggia, la Santa Madre di Jiujiang guida il Signore del tuono, la Madre del lampo, il Conte del vento, il Maestro della pioggia, i generali delle nubi, gli ufficiali e gli spiriti delle acque fuori dal palazzo, dalla sfera divina al mondo umano.",
    },
    detailedDescription: {
  ...
  "lm-m02": {
    title: {
      en: "Return to the Palace After Rain",
      it: "Ritorno a palazzo dopo la pioggia",
    },
    displayTitle: {
      en: "Return to the Palace After Rain",
      it: "Ritorno a palazzo dopo la pioggia",
